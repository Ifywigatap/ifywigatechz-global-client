...
import { MODULES } from '../data/microsoftData.js';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-950 to-slate-900">
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div className="lg:col-span-2">
            ...
            <div className="relative mb-8 aspect-video overflow-hidden rounded-2xl bg-slate-800 shadow-2xl">
              {module.videoId ? (
                ...
                <div className="flex h-full items-center justify-center bg-gradient-to-r from-blue-700 to-blue-600">
            ...
            <div className="space-y-6">
              ...
              <div className="relative">
                <div className="rounded-2xl border border-slate-700 bg-slate-800/50 p-8 backdrop-blur-xl transition-all duration-300 hover:border-blue-400/30">
              ...
              <div className="flex gap-4">
                <button
                  ...
                  className="flex-1 rounded-2xl bg-gradient-to-r from-blue-500 to-blue-600 px-8 py-4 font-bold text-white shadow-xl transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl active:scale-[0.98]"
          ...
          <div className="space-y-6">
            <div className="rounded-[2rem] border border-slate-700/50 bg-slate-900/70 p-6 shadow-2xl shadow-blue-500/10 backdrop-blur-xl">
              <div className="flex items-center justify-between gap-4">
                ...
                <span className="rounded-2xl bg-blue-500/10 px-3 py-1 text-xs font-semibold text-blue-200">
                  {module.badge}
                </span>
              </div>
              ...
              <div className="mt-6 grid gap-3 rounded-3xl border border-slate-700/50 bg-slate-950/70 p-4">
                ...
                <div className="flex items-center justify-between text-sm text-slate-400">
                  <span>Status</span>
                  <span className={module.locked ? 'text-amber-300' : 'text-blue-300'}>
            ...
            <div className="rounded-[2rem] border border-slate-700/50 bg-slate-900/70 p-6 shadow-2xl shadow-slate-950/20 backdrop-blur-xl">
              ...
              <div className="space-y-3">
                {MODULES.slice(parseInt(module.id)).map((m) => (
                  <Link
                    key={m.id}
                    to={`/microsoft/module/${m.id}`}
                    className="group block rounded-3xl border border-slate-800/70 bg-slate-950/60 p-4 transition hover:border-blue-400/40 hover:bg-slate-900/80"
                  >
