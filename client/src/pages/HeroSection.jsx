  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-slate-50 dark:bg-slate-950 flex items-center">
      ...
      <div className="absolute inset-0 overflow-hidden">
        {/* Main Aurora */}
        <div className="absolute top-[-20%] left-[-10%] w-[800px] h-[800px] rounded-full bg-cyan-500/20 blur-[200px]" />

        <div className="absolute bottom-[-20%] right-[-10%] w-[800px] h-[800px] rounded-full bg-blue-600/20 blur-[220px]" />

        <div className="absolute top-[30%] left-[40%] w-[500px] h-[500px] rounded-full bg-indigo-500/10 blur-[180px]" />
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        <div className="grid lg:grid-cols-2 lg:gap-12 items-center">
          ...
          >
            ...
            {/* Sub Heading */}
            <h2 className="mt-6 text-4xl sm:text-5xl font-black tracking-tight text-indigo-300 dark:text-slate-100">
              BUILDING MODERN WEBSITES,
              <span className="block bg-gradient-to-r from-cyan-400 via-blue-500 to-indigo-500 bg-clip-text text-transparent">
              WEB APPLICATIONS & DIGITAL SOLUIONS
              </span>
            </h2>

            {/* Description */}
            <p className="mt-8 text-lg text-slate-700 dark:text-slate-200 max-w-xl leading-relaxed">
